 ...
 * @author neo
 */
public class IUNuevaPrestacion extends IUVentanaT{
    ...
    public IUNuevaPrestacion(IUVentanaHotel ventanaPrincipal, String titulo, Limitacion limitacion) {
    ...
    private void construirSegundoPanel(Limitacion limite){
        ...
        botonGuardar = new IUBoton("guardar prestacion", new Limitacion(limite.getPorcentajeAncho(52), limite.getPorcentajeAlto(30), limite.getPorcentajeAncho(42), limite.getPorcentajeAlto(70)));
    ...
    public Prestacion getPrestacion(){
        Prestacion prestacion = new Prestacion(1);
