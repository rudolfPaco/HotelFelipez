 ...
 * @author neo
 */
public class IUModificarTemporada extends IUVentanaT{
    ...
    public IUModificarTemporada(IUVentanaHotel ventanaPrincipal, CTemporadas controlTemporadas, String titulo, Limitacion limitacion, int porcentajeAlturaTitulo) {
    ...
    private void construirSegundoPanel(Limitacion limite){
        ...
        botonGuardar = new IUBoton("modificar temporada", new Limitacion(limite.getPorcentajeAncho(55), limite.getPorcentajeAlto(20), limite.getPorcentajeAncho(35), limite.getPorcentajeAlto(60)));
    ...
    public void setTemporada(Temporada temporada){
        ...
        precioTemporada.iuTexto.setText(String.valueOf(temporada.getPrecio()));
        precioTemporada.iuTexto.iuUnidad.setText(temporada.getUnidadMoneda().getUnidad());
        tipoMoneda.iuTexto.setSelectedItem(temporada.getUnidadMoneda().getTipo()+" ("+temporada.getUnidadMoneda().getUnidad()+")");
        motivoTeporada.iuAreaTexto.setText(temporada.getMotivo());
    }
