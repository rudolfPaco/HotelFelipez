 ...
 */
public class IUModificarProducto extends IUVentanaT{
    ...
    public IUModificarProducto(IUVentanaHotel ventanaPrincipal, CFrigobar controlFrigobar, String titulo, Limitacion limitacion) {
    ...
    private void construirPrimerPanel(Limitacion limite){
        ...
        panelNombre.iuTexto.setRestriccionLetras();
    ...
    private void construirSegundoPanel(Limitacion limite){
        ...
        botonModificar = new IUBoton("modificar producto", new Limitacion(limite.getPorcentajeAncho(55), limite.getPorcentajeAlto(30), limite.getPorcentajeAncho(40), limite.getPorcentajeAlto(40)));
    ...
    public void setProducto(Producto p){
        this.producto = p;
        panelCategoria.iuTexto.setSelectedItem(p.getCategoria());
        panelMarca.iuTexto.setText(p.getMarca());
        panelNombre.iuTexto.setText(p.getNombre());
        panelMoneda.iuTexto.setSelectedItem(p.getMoneda().getTipo()+" ("+p.getMoneda().getUnidad()+")");
        panelCosto.iuTexto.setText(String.valueOf(Asistente.acotarNumero(p.getCosto(), 2)));
        panelCosto.iuTexto.iuUnidad.setText(p.getMoneda().getUnidad());
        panelPrecio.iuTexto.setText(String.valueOf(Asistente.acotarNumero(p.getPrecio(), 2)));
        panelPrecio.iuTexto.iuUnidad.setText(p.getMoneda().getUnidad());
        panelCantidad.iuTexto.setText(String.valueOf(p.getCantidad()));
        panelFechaVencimiento.iuTexto.setText(p.getFechaVencimiento());
        panelPromocion.iuTexto.setText(p.getPromocion());
    }
    public Producto getProducto(){
        ...
        p.setIdfrigobar(producto.getIdfrigobar());
        p.setIdhabitacion(producto.getIdhabitacion());
