 ...
 */
public class IUNuevaMoneda extends IUVentanaT{
    ...
    public IUNuevaMoneda(IUVentanaHotel ventanaPrincipal, String titulo, Limitacion limitacion) {
    ...
    private void construirSegundoPanel(Limitacion limite){
        ...
        botonGuardar = new IUBoton("guardar moneda", new Limitacion(limite.getPorcentajeAncho(50), limite.getPorcentajeAlto(3), limite.getPorcentajeAncho(40), limite.getPorcentajeAlto(88)));
