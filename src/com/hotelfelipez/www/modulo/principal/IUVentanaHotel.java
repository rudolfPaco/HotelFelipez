...
public class IUVentanaHotel extends IUVentanaP{
    ...
    private void ventanaOcupado(CHabitaciones controlHabitaciones, Habitacion hab){
        setOpacity(0.5f);
        IUVentanaRegistroHospedajeOcupado registroOcupado = new IUVentanaRegistroHospedajeOcupado(this, controlHabitaciones, "Registro Hospedaje Ocupado    Habitacion: "+hab.getNombreHabitacion(), new Limitacion(Asistente.ANCHO, Asistente.ALTO));
