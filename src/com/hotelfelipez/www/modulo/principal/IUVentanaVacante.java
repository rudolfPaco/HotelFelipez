 ...
 */
public class IUVentanaVacante extends IUVentanaT{
    ...
    public IUVentanaVacante(JFrame ventanaPrincipal, String titulo, Limitacion limitacion, String[] nombresBotones) {
